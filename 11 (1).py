...
def zadanie(a):
    if a == 0:
        ...
        s = 'Min количество промежуточных хозяев у Diphyllobothrium latum'
    elif a == 3:
        ...
        s = 'Сколько ходильных конечностей у насекомых?'
    elif a == 7:
        s = 'pH нейтральной среды'
    elif a == 8:
        s = 'Сколько ходильных конечностей у паукообразных?'
    elif a == 9:
        s = 'Какой порядковый номер имеет самый электроотрицательный элемент?'
    return(s)
main()
