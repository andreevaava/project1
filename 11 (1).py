...
def zadanie(a):
    if a == 0:
        s = 'Кликай на кружки с цифрой пупупупуууууууу'
    elif a == 1:
        s = 'Кликай на кружки с цифрой один'
    elif a == 2:
        s = 'Кликай на кружки с цифрой два'
    elif a == 3:
        s = 'Кликай на кружки с цифрой три'
    elif a == 4:
        s = 'Кликай на кружки с цифрой четыре'
    elif a == 5:
        s = 'Кликай на кружки с цифрой пять'
    elif a == 6:
        s = 'Кликай на кружки с цифрой шесть'
    elif a == 7:
        s = 'Кликай на кружки с цифрой семь'
    elif a == 8:
        s = 'Кликай на кружки с цифрой восемь'
    elif a == 9:
        s = 'Кликай на кружки с цифрой девять'
    return(s)
main()
